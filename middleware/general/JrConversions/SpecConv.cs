...
{
    [Serializable]
    public class NdDualConversionProvider
    {
        public NdUnitAgConversionData ConversionDataObject = null;
        public IISpecialConversionDelegate ConversionDelegate = null;

        public bool HasBadConversionFactor()
        {
            var result = false;
            if (ConversionDataObject != null) result = ConversionDataObject.HasBadConversionFactor();
