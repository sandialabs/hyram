...
//        private bool _ignoreStateChange = false;
        ...
        private void RefreshParameterGrid()
        {
            ...
            // change label of pressure input for gauge/absolute
            int fluidPressureRow = 0;
            ...
            var pressureDescripCell = (DataGridViewTextBoxCell)ParameterGrid.Rows[fluidPressureRow].Cells[0];
