...
namespace SandiaNationalLaboratories.Hyram
{
    public partial class JetFlameHeatAnalysisForm : UserControl
    {
        ...
        private void JetFlameHeatAnalysisForm_Load(object sender, EventArgs e)
        {
            ...
            // Populate radiative source models CB and exclude None option
            radiativeSourceSelector.Items.Add(RadiativeSourceModels.Single);
            radiativeSourceSelector.Items.Add(RadiativeSourceModels.Multi);
            ...
            radiativeSourceSelector.SelectedItem = selectedRadSrc;
        ...
        private void RefreshGridParameters()
        {
            ...
            if (StateContainer.FuelTypeIsGaseous())
            {
                formParams.Add("fluidPressure",
                    new ParameterWrapper("fluidPressure", "Tank fluid pressure", PressureUnit.Pa,
                        StockConverters.PressureConverter));
        ...
        {
            StateContainer.SetValue("RadiativeSourceModel", (RadiativeSourceModels) radiativeSourceSelector.SelectedItem);
        }
