...
import hyram.qra.pipe_size as hyram_pipesize
...
class TestPipeSizeCalcs(unittest.TestCase):
    ...
    def test_calc_pipe_inner_diameter(self):
        ...
        pipe_inner_diameter = hyram_pipesize.calc_pipe_inner_diameter(pipe_outer_diameter,
                                                                      pipe_wall_thickness)
    ...
    def test_calc_pipe_flow_area(self):
        ...
        pipe_flow_area = hyram_pipesize.calc_pipe_flow_area(pipe_inner_diameter)
        # Hand-calculation of above numbers
    ...
    def test_calc_orifice_diameter(self):
        ...
        leak_diameter = hyram_pipesize.calc_orifice_diameter(pipe_flow_area,
                                                             leak_size_fraction)
        # Hand-calculation of above numbers
