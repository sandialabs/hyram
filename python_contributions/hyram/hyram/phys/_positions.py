...
class PositionGenerator:
    ...
    Exclusion radius is the minimum distance (in xz-plane) from (0,0)
    ...
    def __init__(self, loc_distributions, exclusion_radius, seed):
        ...
        exclusion_radius : float
            Minimum distance in xz-plane from (0,0) that all generated
            positions must be.
        seed : int
        ...
        # Number of extra to generate in case some insize exclusion zone
        self.extra = 3
    ...
    def gen_positions(self):
        ...
        for dist in self.loc_distributions:
            ...
            def get_valid(locs, num_needed):
               # Find all the ones that were valid (x**2 + z**2 < r**2)
                valid_idx = np.where(locs[0]**2 + locs[2]**2 > self.exclusion_radius**2)
