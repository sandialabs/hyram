...
appname="HyRAM"
version="6.0.0"  # Make sure to update distribution file entry as well
appId="com.SandiaNationalLaboratories.HyRAM"
...
echo "Note that errors may have occurred. Review the log above to verify the outcome."
