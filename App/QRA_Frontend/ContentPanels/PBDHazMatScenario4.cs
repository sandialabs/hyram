...
{
    public partial class CpHazMatScenario4 : UserControl, IQraBaseNotify
    {
        public CpHazMatScenario4()
        {
            InitializeComponent();
        }

        private void cpHazMatScenario4_Load(object sender, EventArgs e)
        {
        }
