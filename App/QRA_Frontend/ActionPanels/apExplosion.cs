...
{
    public partial class ApExplosion : UserControl, IQraBaseNotify
    {
        public ApExplosion()
        {
            InitializeComponent();
        ...
        private void btnScenario1_Click(object sender, EventArgs e)
        {
            try
            {
                ActionUtils.SetContentScreen((Button) sender, new CpExplosionScenario1());
            }
            catch (Exception ex)
            {
        ...
        private void btnScenario2_Click(object sender, EventArgs e)
        {
            try
            {
                ActionUtils.SetContentScreen((Button) sender, new CpExplosionScenario2());
            }
            catch (Exception ex)
            {
                MessageBox.Show("Action failed with this error: " + ex.Message);
        ...
        private void btnScenario3_Click(object sender, EventArgs e)
        {
            try
            {
                ActionUtils.SetContentScreen((Button) sender, new CpExplosionScenario3());
            }
            catch (Exception ex)
            {
                MessageBox.Show("Action failed with this error: " + ex.Message);
