...
{
    public partial class ApJetFlame : UserControl
    {
        public ApJetFlame()
        {
            InitializeComponent();
        ...
        private void btnPlotT_Click(object sender, EventArgs e)
        {
            try
            {
                ActionUtils.SetContentScreen((Button) sender, new CpPlotT());
            }
            catch (Exception ex)
            {
                MessageBox.Show("Action failed with this error: " + ex.Message);
