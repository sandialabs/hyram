...
namespace QRA_Frontend.ActionPanels
{
    ...
    {
        private static IQraBaseNotify _mActiveContentPanel;

        public static IQraBaseNotify ActiveContentPanel
        {
            get
            {
                IQraBaseNotify result = null;
                lock (Synchronize.LockId)
                {
                    result = _mActiveContentPanel;
                }
